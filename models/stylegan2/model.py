"""
StyleGAN2 Generator — ported from rosinality/stylegan2-pytorch.
Architecture must match exactly for pretrained weight compatibility.
"""
...
class Generator(nn.Module):
    def __init__(self, size, style_dim, n_mlp, channel_multiplier=2,
        ...
        for i in range(3, self.log_size + 1):
            ...
            self.convs.append(
                StyledConv(out_channel, out_channel, 3, style_dim,
